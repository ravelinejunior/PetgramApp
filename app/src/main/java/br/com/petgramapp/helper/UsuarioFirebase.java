...
public class UsuarioFirebase {
    ...
    public static Usuario getUsuarioLogado(){
        ...
        usuario.setEmailPetUsuario(firebaseUser.getEmail());
        usuario.setNomePetUsuario(firebaseUser.getDisplayName());
        usuario.setId(firebaseUser.getUid());
        if (firebaseUser.getPhotoUrl() == null){
            usuario.setUriCaminhoFotoPetUsuario("");
        }else{
            usuario.setUriCaminhoFotoPetUsuario(firebaseUser.getPhotoUrl().toString());
        }
        usuario.setIdadePetUsuario(firebaseUser.getProviderId());
        return usuario;
    }
}
